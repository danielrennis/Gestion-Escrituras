...
nomenclatura_castastral: "Parcela 3, Manzana 3, Quinta 12, Sección B, Circunscripción 1"
...
*   **Vendedor:** Alvarez Clara Gladis (representada por Carlos Hugo Rennis).
*   **Comprador:** Hugo Daniel Rennis.
*   **Precio de Venta:** $7.000,00.
*   **Escribano:** Martin Juan Jose (Registro N° 2, Machagai).
*   **Inscripción RPI:** Folio Real Matrícula 4239 (Departamento 25 de Mayo).

## Características del Inmueble
*   **Ubicación:** Parcela Tres (3) de la Manzana Tres (3), Quinta Doce (12), Sección B, Circunscripción 1, Machagai, Chaco.
*   **Superficie Total:** 2.500,00 metros cuadrados.
*   **Medidas:** Un cuadrado perfecto de 50 metros de lado (50m x 50m).
*   **Linderos:**
    *   Norte: Parcela 2.
    *   Sur: Calle pública.
    *   Este: Calle en medio con Parcela 2.
    *   Oeste: Parcela 4.
...
- **Estado**: Digitalizado y sincronizado.
